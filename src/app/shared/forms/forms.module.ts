...
import { formsInitialState, formsReducer, formsStoreName } from '@app/shared/forms/+store/forms.reducer';
import { ArrayComponent } from '@app/shared/forms/components/array/array.component';
import { AutoCompleteAsyncWrapperComponent, AutoCompleteComponent, AutoCompleteWrapperComponent } from '@app/shared/forms/components/auto-complete/auto-complete.component';
import { CheckboxGroupComponent, CheckboxGroupWrapperComponent } from '@app/shared/forms/components/checkbox-group/checkbox-group.component';
import { ErrorMessageComponent } from '@app/shared/forms/components/control-message/error-message.component';
import { DatePickerComponent, DatePickerWrapperComponent } from '@app/shared/forms/components/date-picker/date-picker.component';
import { FormComponent, FormContentComponent } from '@app/shared/forms/components/form-container/form-content.component';
...
import { NumberComponent, NumberWrapperComponent } from '@app/shared/forms/components/number/number.component';
import { RadioGroupComponent, RadioGroupWrapperComponent } from '@app/shared/forms/components/radio-group/radio-group.component';
import { SelectComponent, SelectWrapperComponent } from '@app/shared/forms/components/select/select.component';
import { SizePickerComponent } from '@app/shared/forms/components/size-picker/size-picker.component';
import { TextAreaComponent, TextAreaWrapperComponent } from '@app/shared/forms/components/text-area/text-area.component';
import { TextInputComponent, TextInputWrapperComponent } from '@app/shared/forms/components/text-input/text-input.component';
